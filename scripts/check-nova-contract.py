...
ACCESSORS = "optString|optBoolean|optInt|optLong|optDouble|optJSONObject|optJSONArray|opt|getString|getBoolean|getInt|getLong|getJSONObject|getJSONArray|has|isNull"
