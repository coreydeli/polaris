...
- The [Spaces guide](https://papi-ux.com/docs/spaces/) reads in the order you meet it: what a Space is, whether you need one, Docker, the first Space, devices, what disconnect does, and what to do when it breaks.
