...
- The Steam Controller (2026) gets an emulated DualSense when Moonlight reports one, with its gyro and both touchpads: the left pad on the left half of the DualSense touchpad, the right pad on the right half.
