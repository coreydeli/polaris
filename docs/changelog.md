...
- On a build without a published gaming runtime, the Spaces page reads as ready and waiting: the Spaces configuration check becomes a neutral waiting row left out of the count, Host Setup says Host ready, and the check no longer says host preparation comes first.
